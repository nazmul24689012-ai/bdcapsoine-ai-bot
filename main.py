...
if not BOT_TOKEN or not GEMINI_API_KEY:
    raise ValueError("BOT_TOKEN বা GEMINI_API_KEY পাওয়া যায়নি!")
...
async def generate_story():
    ...
    prompt = f"বিষয়: {topic} নিয়ে ফেসবুকে ভাইরাল হওয়া বাস্তব ব্রেকআপের গল্পের মতো করে একটি বড় গল্প লেখো। যত বড় পারো, কোনো লিমিট নেই। বাস্তব ও ইমোশনাল হতে হবে। আত্মহত্যায় উৎসাহ দেবে না। শুধু গল্প লেখো।"
